...
metadata:
  openclaw:
    homepage: https://github.com/luoli523/guige-skills#guige-translate
    requires:
      anyBins:
        - bun
        - npx
...
| Priority | Path | Scope |
|----------|------|-------|
| 1 | `.guige-skills/guige-translate/EXTEND.md` | Project |
| 2 | `${XDG_CONFIG_HOME:-$HOME/.config}/guige-skills/guige-translate/EXTEND.md` | XDG |
| 3 | `$HOME/.guige-skills/guige-translate/EXTEND.md` | User home |
