...
description: First-time setup flow for guige-translate preferences
---
...
options:
  - label: "User (Recommended)"
    description: "$HOME/.guige-skills/ (all projects)"
  - label: "Project"
...
| Choice | Path | Scope |
|--------|------|-------|
| User | `$HOME/.guige-skills/guige-translate/EXTEND.md` | All projects |
| Project | `.guige-skills/guige-translate/EXTEND.md` | Current project |
