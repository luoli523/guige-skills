...
guige-fetch - Read a URL into Markdown or JSON with Chrome CDP

Usage:
  guige-fetch <url> [options]
...
Options:
  ...
  --chrome-profile-dir <path>
                        Chrome user data dir. Defaults to GUIGE_CHROME_PROFILE_DIR
                        or guige-skills/chrome-profile.
...
Examples:
  guige-fetch https://example.com
  guige-fetch https://example.com --format markdown --output article.md --download-media
  guige-fetch https://example.com --format json --output article.json
  guige-fetch https://x.com/lennysan/status/2036483059407810640 --wait-for interaction
  guige-fetch https://x.com/lennysan/status/2036483059407810640 --wait-for force
`.trim();
