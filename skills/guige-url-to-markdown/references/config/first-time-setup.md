...
description: First-time setup flow for guige-url-to-markdown preferences
---
...
options:
  - label: "User (Recommended)"
    description: "~/.guige-skills/ (all projects)"
  - label: "Project"
    description: ".guige-skills/ (this project only)"
```
...
| Choice | Path | Scope |
|--------|------|-------|
| User | `~/.guige-skills/guige-url-to-markdown/EXTEND.md` | All projects |
| Project | `.guige-skills/guige-url-to-markdown/EXTEND.md` | Current project |
